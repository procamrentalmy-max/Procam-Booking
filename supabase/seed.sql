...
insert into rental_packages (product_id, name, duration_minutes, price_myr, deposit_myr, late_fee_per_hour_myr, active, is_overnight) values
  ...
  ('40000000-0000-0000-0000-000000000001', '3 Hours', 180, 50.00, 300.00, 20.00, true, false),
  ('40000000-0000-0000-0000-000000000001', '4 Hours', 240, 60.00, 300.00, 20.00, true, false),
  ('40000000-0000-0000-0000-000000000001', '5 Hours', 300, 68.00, 300.00, 20.00, true, false),
  ('40000000-0000-0000-0000-000000000001', '6 Hours', 360, 75.00, 300.00, 20.00, true, false),
  ('40000000-0000-0000-0000-000000000001', '7 Hours', 420, 80.00, 300.00, 20.00, true, false),
  ('40000000-0000-0000-0000-000000000001', '8 Hours', 480, 85.00, 300.00, 20.00, true, false),
...
-- DJI Neo 2 packages: same duration ladder, schedule, and deposit as the
-- Insta360 (9am-8pm daytime, 9pm-8am overnight, 1-5 day tiers, RM300
-- deposit), priced RM5 under the equivalent Insta360 tier.
insert into rental_packages (product_id, name, duration_minutes, price_myr, deposit_myr, late_fee_per_hour_myr, active, is_overnight) values
  ('40000000-0000-0000-0000-000000000003', '1 Hour', 60, 20.00, 300.00, 20.00, false, false),
  ('40000000-0000-0000-0000-000000000003', '2 Hours', 120, 30.00, 300.00, 20.00, true, false),
  ('40000000-0000-0000-0000-000000000003', '3 Hours', 180, 40.00, 300.00, 20.00, true, false),
  ('40000000-0000-0000-0000-000000000003', '4 Hours', 240, 50.00, 300.00, 20.00, true, false),
  ('40000000-0000-0000-0000-000000000003', '5 Hours', 300, 58.00, 300.00, 20.00, true, false),
  ('40000000-0000-0000-0000-000000000003', '6 Hours', 360, 65.00, 300.00, 20.00, true, false),
  ('40000000-0000-0000-0000-000000000003', '7 Hours', 420, 70.00, 300.00, 20.00, true, false),
  ('40000000-0000-0000-0000-000000000003', '8 Hours', 480, 75.00, 300.00, 20.00, true, false),
  ('40000000-0000-0000-0000-000000000003', '9 Hours', 540, 80.00, 300.00, 20.00, true, false),
  ('40000000-0000-0000-0000-000000000003', '10 Hours', 600, 85.00, 300.00, 20.00, true, false),
  ('40000000-0000-0000-0000-000000000003', '11 Hours', 660, 90.00, 300.00, 20.00, true, false),
  ('40000000-0000-0000-0000-000000000003', 'Overnight (9pm-8am)', 660, 50.00, 300.00, 20.00, true, true),
  ('40000000-0000-0000-0000-000000000003', '24 Hours (1 Day)', 1440, 110.00, 300.00, 20.00, true, false),
  ('40000000-0000-0000-0000-000000000003', '2 Days', 2880, 155.00, 300.00, 20.00, true, false),
  ('40000000-0000-0000-0000-000000000003', '3 Days', 4320, 195.00, 300.00, 20.00, true, false),
  ('40000000-0000-0000-0000-000000000003', '4 Days', 5760, 230.00, 300.00, 20.00, true, false),
  ('40000000-0000-0000-0000-000000000003', '5 Days', 7200, 260.00, 300.00, 20.00, true, false);
