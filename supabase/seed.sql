...
-- overnight modeled as a separate, unconflicted nightly slot). 2hr/3hr
-- added as shorter options at the same per-hour rate trend. Named by plain
-- duration ("4 Hours") rather than a marketing tier name — the booking
-- wizard picks a package by its duration (start/end time), not by name.
-- The only active packages in the system now.
insert into rental_packages (product_id, name, duration_minutes, price_myr, deposit_myr, late_fee_per_hour_myr, active, is_overnight) values
  ...
  ('40000000-0000-0000-0000-000000000001', '3 Hours', 180, 52.00, 300.00, 20.00, true, false),
  ('40000000-0000-0000-0000-000000000001', '4 Hours', 240, 59.00, 300.00, 20.00, true, false),
  ('40000000-0000-0000-0000-000000000001', '5 Hours', 300, 66.00, 300.00, 20.00, true, false),
  ('40000000-0000-0000-0000-000000000001', '6 Hours', 360, 72.00, 300.00, 20.00, true, false),
